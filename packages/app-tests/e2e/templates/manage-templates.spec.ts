...
test('[TEMPLATES]: use template', async ({ page }) => {
  ...
  await page.getByPlaceholder('recipient.1@tofes-mekovan.co.il').click();
  await page.getByPlaceholder('recipient.1@tofes-mekovan.co.il').fill(teamMemberUser.email);
