      ...
      <Card>
        <CardContent className="p-0">
          <Table overflowHidden>
            <TableHeader>
              <TableRow>
                <TableHead>{_(msg`אירועי חותם`)}</TableHead>
                <TableHead>{_(msg`חתימה`)}</TableHead>
                <TableHead>{_(msg`פרטים`)}</TableHead>
              </TableRow>
            </TableHeader>
                        ...
                        <>
                          ...
                          <p className="text-muted-foreground mt-2 text-sm print:text-xs">
                            ...
                            <span className="inline-block">
                              {logs.DOCUMENT_RECIPIENT_COMPLETED[0]?.ipAddress ?? _(msg`לא ידוע`)}
                            </span>
                          </p>
