...
const FOOTER_LINKS = [
  ...
  { href: 'https://docs.tofes-mekovan.co.il', text: msg`Documentation`, target: '_blank' },
  ...
  { href: 'https://shop.tofes-mekovan.co.il', text: msg`Shop`, target: '_blank' },
  { href: 'https://status.tofes-mekovan.co.il', text: msg`Status`, target: '_blank' },
