...
At Tofes-Mekovan, we aim to be a design-driven company.
...
To achieve this, we've created Tofes-Mekovan's design system containing tokens, primitives, and components, screens, and brand assets.
