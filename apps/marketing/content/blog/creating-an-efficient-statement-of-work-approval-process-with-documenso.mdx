---
title: Creating an Efficient Statement of Work Approval Process with Tofes-Mekovan
...
> TLDR; Statements of Work detail what needs to be done. Automate sending and approving them using Tofes-Mekovan and Zapier.
...
<figure>
  <MdxNextImage src="/blog/roles.webp" width="1400" height="884" alt="Tofes-Mekovan Roles UI" />
  <figcaption className="text-center">
    Let's take a look at what it would look like with Tofes-Mekovan.
  </figcaption>
</figure>

### 1. Creating the Document: Templates vs. Custom Document

[Creating a template](https://docs.tofes-mekovan.co.il/users/templates) can make sense if you submit statements of work regularly. If you create a Tofes-Mekovan Template, you can add [dynamic text and number fields](https://docs.tofes-mekovan.co.il/users/signing-documents/fields) to be filled out when using the template. Another approach to this is creating a template on a document service like Google Docs, filling out a new copy, and uploading the custom-created document to Tofes-Mekovan.

Different parts of this process can be automated using the [Zapier Tofes-Mekovan Integration](https://documen.so/zapier) as desired:

- Automatically sending out a template to be filled out and signed
- Creating a document in Tofes-Mekovan from a newly created document in Google Docs
