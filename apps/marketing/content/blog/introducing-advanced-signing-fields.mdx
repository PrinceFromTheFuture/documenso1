...
description: "Explore Tofes-Mekovan's new advanced signing fields, including improved text fields, numbers, radio buttons, checkboxes, and dropdowns. Learn about the development challenges we overcame and how these additions provide greater flexibility for document signing."
...
Until recently, Tofes-Mekovan provided a set of 5 fields for document signing: signature, email, name, date, and a text field for additional information. While these fields covered the basic requirements for document signing, we recognized the need for more flexibility and variety.
...
These new fields bring more flexibility and variety to Tofes-Mekovan. As the document owner, they allow you to gather more specific or extra information from the signers.
...
![Old text signing field in the Tofes-Mekovan document editor](/blog/advanced-fields/old-text-field.jpeg)
...
![The advanced settings tab for the text field in the Tofes-Mekovan document editor](/blog/advanced-fields/text-field-advanced-settings.webp)
...
![The text signing field on the Tofes-Mekovan signing page](/blog/advanced-fields/text-field-signing.webp)
...
![The advanced settings tab for the number field on the Tofes-Mekovan document editor page](/blog/advanced-fields/number-field-advanced-settings.webp)
...
![The advanced settings tab for the radio field in the Tofes-Mekovan document editor](/blog/advanced-fields/radio-field-advanced-settings.webp)

The image below shows what the signer sees after the document is sent for signing.

![The radio signing field on the Tofes-Mekovan signing page](/blog/advanced-fields/radio-field-sign-page.webp)
...
![The advanced settings tab for the select field in the Tofes-Mekovan document editor](/blog/advanced-fields/select-field-advanced-settings.webp)

On the signing page, the "Dropdown/Select" field appears as shown below:

![The select field on the Tofes-Mekovan document signing page](/blog/advanced-fields/select-field-sign-page.webp)
...
![The advanced settings tab for the checkbox field in the Tofes-Mekovan document editor](/blog/advanced-fields/checkbox-field-advanced-settings.webp)

When a signer receives the document, they will see the "Checkbox" field as shown below:

![The checkbox field on the Tofes-Mekovan document signing page](/blog/advanced-fields/checkbox-sign-page.webp)
...
![Tofes-Mekovan advanced field signing](/blog/advanced-fields/documenso-advanced-fields-signing.webp)
...
![Tofes-Mekovan field advanced settings](/blog/advanced-fields/documenso-field-advanced-settings.webp)
...
![The radio and checkbox signing fields on the Tofes-Mekovan document signing page](/blog/advanced-fields/radio-and-checkbox-fields.webp)
...
![Screenshot illustrating the active state for a field on the Tofes-Mekovan document editor page](/blog/advanced-fields/field-active-state.webp)

The second image shows the "Signature" field in the normal state.

![Screenshot illustrating the fields for a signer on the Tofes-Mekovan document editor page](/blog/advanced-fields/recipient-colours.webp)
...
![Screenshot illustrating the recipient colour on the Tofes-Mekovan document editor page](/blog/advanced-fields/recipient-colour-example.webp)
...
> The file was truncated for readability. You can see the complete code in the [signer-colors.ts](https://github.com/documenso/documenso/blob/main/packages/ui/lib/signer-colors.ts) file from the Tofes-Mekovan repository.
