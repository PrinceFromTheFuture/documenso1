...
Following the release of both Server Actions and Server Components, we at Tofes-Mekovan embarked on a rewrite of the application. We had accumulated a bit of technical debt from the initial MVP, which was best shed as we also improved the design with help from our new designer.
