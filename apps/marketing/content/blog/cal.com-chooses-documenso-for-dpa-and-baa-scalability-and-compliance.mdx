---
title: Cal.com Chooses Tofes-Mekovan for DPA and BAA Scalability and Compliance
description: Learn how Cal.com scales their Data Processing Agreement (DPA) and Business Associate Agreement (BAA) processes with Tofes-Mekovan’s open source platform as they grow.
...
TL;DR: Cal.com uses Tofes-Mekovan’s template direct links to facilitate low-friction compliance paperwork, enhancing scalability and user experience.
...
Tofes-Mekovan offers exactly this solution through direct link templates, enabling Cal.com to:
...
Direct Link templates can also easily be embedded, using the [Tofes-Mekovan widget](https://documen.so/embedded). Embedding anywhere, pre-Filling the templates and notfiying the compliance team at certain point of the flow are a few of the many option the team now has in continously enhanceing their onboard and compliance UX.

Read more about our direct link templates here: [Direct Link Signing](https://docs.tofes-mekovan.co.il/users/direct-links).

## The Journey

Initially, Cal.com’s team approached the new solution with skepticism. As Bailey reflected:

> We were intrigued but skeptical at first, as we put a lot of thought into compliance and doing things right. Tofes-Mekovan’s documentation and support showcased how their direct link templates could meet our needs while being highly compliant.

This experience highlights Tofes-Mekovan’s trust philosophy. We strive to be transparent in everything we do and let people judge for themselves. It also shows that we neither want nor get trust by default. Doing things right is a conversation worth having, especially in a space as opaque as digital signatures. It goes without saying that the whole team is hyped to have Cal.com on board and yet another open source company joining the open signing movement 🚀
