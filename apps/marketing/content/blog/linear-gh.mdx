...
- Putting different aspects of Tofes-Mekovan close to each other: Development, Design, Community
...
Apart from the source code of the Tofes-Mekovan app and website, the main repo houses issues raised by the community and issues where we invite the community to participate.
...
We already have design.tofes-mekovan.co.il housing our general design system. Here, we will publish the specifics of how we applied this to each feature. We will publish the first artifacts here soon, what may be in the cards can be found on the [LIVE Roadmap](https://documen.so/live).
