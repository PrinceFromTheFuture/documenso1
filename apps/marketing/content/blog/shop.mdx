...
<figure>
  <MdxNextImage
    ...
    width="1260"
    height="630"
    alt="Malfunctioning Mania Themed Tofes-Mekovan Shirt"
  />
...
<figure>
  ...
  <figcaption className="text-center">
    Merch at Tofes-Mekovan is always given to those who deserve it.
  </figcaption>
</figure>
...
**[Follow Tofes-Mekovan on Twitter / X](https://documen.so/tw) and [join the Discord server](https://documen.so/discord) to get the latest updates about Malfunction Mania.**
