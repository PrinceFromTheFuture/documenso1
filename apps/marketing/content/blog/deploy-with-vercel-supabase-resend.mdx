---
title: 'Deploying Tofes-Mekovan with Vercel, Supabase and Resend'
description: This is the first part of the new Building Tofes-Mekovan series, where I describe the challenges and design choices that we make while building the world’s most open signing platform.
...
In this article, we'll walk you through how to deploy and self-host Tofes-Mekovan using Vercel, Supabase, and Resend.
...
If you don't know what [Tofes-Mekovan](https://documenso.com/) is, it's an open-source alternative to DocuSign, with the mission to create an open signing infrastructure while embracing openness, cooperation, and transparency.
...
## Step-by-Step guide to deploying Tofes-Mekovan with Vercel, Supabase, and Resend

To deploy Tofes-Mekovan, we'll take the following steps:

1. Fork the Tofes-Mekovan repository
...
### Step 1: Fork the Tofes-Mekovan repository

Start by creating a fork of Tofes-Mekovan on GitHub. You can do this by visiting the [Tofes-Mekovan repository](https://github.com/documenso/documenso) and clicking on the 'Fork' button. (Also, star the repo!)

![Tofes-Mekovan](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/wkcujctpf86p56bju3mq.png)

Choose your GitHub profile as the owner and click on 'Create fork' to create a fork of the repo.

![Fork the Tofes-Mekovan repository on GitHub](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/xf49r2byu9nnd1465niy.png)
...
So, you've just cloned Tofes-Mekovan, installed dependencies on your local machine, and set your database using Supabase. Now, SMTP is missing. Emails won't go out! Let's fix it with Resend.
...
On your Vercel dashboard, create a new project using the forked project from your GitHub repositories. Select the project among the options and click '**Import**' to start running Tofes-Mekovan.
...
![Deploying Tofes-Mekovan](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/secg29j9j40o4u2oa8o8.png)

Congratulations! 🎉 You've successfully deployed Tofes-Mekovan using Vercel, Supabase, and Resend. You're now ready to create and sign your own documents with your self-hosted Tofes-Mekovan!
