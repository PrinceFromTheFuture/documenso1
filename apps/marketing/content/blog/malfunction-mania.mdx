...
description: Launch Week Day 2 Y'all! We're getting ready to release Tofes-Mekovan 1.0! Join in on the fun of making sure the open-source alternative to DocuSign is on point. We're calling a 'MALFUNCTION MANIA.'
...
<figure>
  <MdxNextImage
    ...
    width="1260"
    height="630"
    alt="Malfunctioning Tofes-Mekovan Logo in broken colors"
  />
...
**[Follow Tofes-Mekovan on Twitter / X](https://documen.so/tw) and [join the Discord server](https://documen.so/discord) to get the latest about Malfunction Mania.**
