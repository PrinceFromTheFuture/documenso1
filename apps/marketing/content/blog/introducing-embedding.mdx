---
title: 'Introducing Embedding Support for Tofes-Mekovan'
...
When we first launched Tofes-Mekovan, one of the most requested features was embedding. We knew it was important and aligned with our desire to not just be a e-signing application but to instead provide the e-signature infrastructure for the web and beyond.
...
We're always here to help! If you have questions or need support, join our [Discord](https://documen.so/discord) or [book a demo](https://documen.so/book-a-demo). We'd love to hear how you're using Tofes-Mekovan or wanting to use Tofes-Mekovan to enhance your workflow.

Stay tuned for more updates as we continue to evolve the Tofes-Mekovan platform and make it even easier to bring document signing into your workflows.
