...
# Tofes-Mekovan v1.8.0: Team Preferences, Signature Rejection, and Document Distribution

We're excited to announce the release of Tofes-Mekovan v1.8.0! This update brings powerful new features to enhance your document signing process. Here's what's new:
...
As always, we're grateful for the community's contributions and feedback. Your support helps us improve Tofes-Mekovan and deliver a top-notch open-source document signing solution.

We hope you enjoy the new features in Tofes-Mekovan v1.8.0. Happy signing!

---

# Tofes-Mekovan v1.7.1: Signing order and document visibility

We're excited to introduce Tofes-Mekovan v1.7.1, bringing you improved control over your document signing process. Here are the key updates:
...
As always, we're grateful for our community's contributions and feedback. Your input continues to shape Tofes-Mekovan into the leading open-source document signing solution.

We're eager to see how these new features enhance your document workflows. Enjoy exploring Tofes-Mekovan v1.7.1!

---

# Tofes-Mekovan v1.7.0: Embedded Signing, Copy and Paste, and More

We're thrilled to announce the release of Tofes-Mekovan v1.7.0, packed with exciting new features and improvements that enhance document signing flexibility, user experience, and global accessibility.
...
Take your document signing to the next level with our new embedded signing feature. Now you can seamlessly integrate Tofes-Mekovan's signing process directly into your own website or application, providing a smooth, branded experience for your users.
...
Check out our [Embedding documentation](https://docs.tofes-mekovan.co.il/developers/embedding) to learn more about how to get started.
...
These enhancements make Tofes-Mekovan more accessible to users worldwide.
...
- [Advanced fields article to help you make the most of Tofes-Mekovan's capabilities](/blog/introducing-advanced-signing-fields)
- [Embedding blog post to guide you through how we implemented embedding](/blog/introducing-embedding)

## 👏 Community Contributions

A big thank you to our vibrant community! This release includes contributions from several new contributors, further enriching Tofes-Mekovan's capabilities.

We're excited to see how you'll use these new features to streamline your document workflows. As always, we appreciate your feedback and support in making Tofes-Mekovan the best open-source document signing solution available.

Enjoy exploring v1.7.0!

---

# Tofes-Mekovan v1.6.1: Internationalization, Enhanced OIDC, and More

We're excited to announce the release of Tofes-Mekovan v1.6.1, which brings several improvements to enhance your document signing experience. Here are the key updates:
...
We've taken a big step towards making Tofes-Mekovan accessible to a global audience by adding i18n (internationalization) support for our marketing pages and adding translations to support multiple languages.

While this is just a small step towards a fully multilingual Tofes-Mekovan, it's a significant step towards making our platform more accessible to a global audience.

Using our new knowledge and findings from the marketing implementation, we aim to tackle our web application in the near future for a fully global Tofes-Mekovan.
...
We've also made various other minor fixes and improvements to ensure a smoother Tofes-Mekovan experience.
...
We appreciate your continued support and feedback as we work to make Tofes-Mekovan the best document signing solution available. Enjoy the new features and improvements in v1.6.1!
...
We're excited to announce the release of Tofes-Mekovan v1.6.0! The new release is packed with new features and improvements to streamline the signing process. Here are the highlights:

### 📚 New Documentation Site

We’ve launched a comprehensive documentation site to help you make the most of Tofes-Mekovan. Check it out to explore all our features and best practices! Based on your feedback, we’re constantly working to improve Tofes-Mekovan. Feel free to ping us to update the docs or even raise PRs.

> Check out the docs at [https://docs.tofes-mekovan.co.il](https://docs.tofes-mekovan.co.il)
...
We've added more customization options for each field type, allowing you to create more dynamic and interactive documents. All non-auto field types allow setting pre-fill values, placeholders, and labels. For more details, see the new [documentation](https://docs.tofes-mekovan.co.il/users/signing-documents/fields).

### 🪪 Public Profiles

We've introduced [Public Profiles](http://localhost:3001/blog/announcing-profiles), allowing you to showcase your professional identity within Tofes-Mekovan and showcase your publicly available templates. This feature enhances transparency and trust in your signing processes. This feature enhances transparency and trust in your signing processes.
...
Learn more about Direct Links [on our blog](https://documenso.com/blog/announcing-direct-links) or try them by signing the [Tofes-Mekovan Supporters Pledge](https://documen.so/pledge).

### 🛂 OpenID Connect (OIDC) Support

Thanks to [Matt Kilgore](https://github.com/tankerkiller125), Tofes-Mekovan now supports OIDC as an authentication provider. This allows self-hosted users to define whatever identity provider they want as long as it supports the OIDC. Azure, Zitadel, Authentik, KeyCloak, and Google all support OIDC.
...
We are pretty hyped about this one: Since version 0.9, we relied on https://github.com/vbuch/node-signpdf to add the digital signatures to our documents. Since signing is at the heart of Tofes-Mekovan, we created our own rust-based library for signing. As of 1.5.4, Tofes-Mekovan's signing runs on @documenso/pdf-sign. The library offers a better architecture to enable signing with private keys that are not stored locally (e.g. via HSM). We are in the process of cleaning up the library to open source it like the rest of Tofes-Mekovan 🌱 The library will also help us to offer Long Term Validation (LTV) for signatures soon. While we are currently limited to signing with PKCS7-B, eventually, we plan to support all common signing standards like PAdES, CAdES, and XAdES.
