...
![Template page in the Tofes-Mekovan dashboard](/direct-links/document-direct-link-documenso.webp)
...
![Enable the document direct link in the Tofes-Mekovan dashboard](/direct-links/enable-document-direct-link-modal.webp)
...
```bash
https://app.tofes-mekovan.co.il/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [Tofes-Mekovan profile](/users/profile) to make them signable anytime.
