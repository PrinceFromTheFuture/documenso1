---
title: Teams
description: Learn how to create and manage teams in Tofes-Mekovan.
---
...
Tofes-Mekovan allows you to create teams to collaborate with others on creating and signing documents.
...
![Tofes-Mekovan account dropdown menu](/get-started-images/add-team.webp)
...
```bash
https://app.tofes-mekovan.co.il/t/<your-team-name>
```

![Tofes-Mekovan create team modal](/get-started-images/add-team-2.webp)
...
```bash
https://app.tofes-mekovan.co.il/t/<your-team-name>/settings/members
```
...
![Invite team members in Tofes-Mekovan dashboard](/get-started-images/add-team-members-documenso.webp)
...
```bash
https://app.tofes-mekovan.co.il/t/<your-team-name>/settings
```

### [Send your First Document](https://app.tofes-mekovan.co.il/)
