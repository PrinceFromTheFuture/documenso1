...
description: Learn how to generate or buy a signing certificate for your Tofes-Mekovan instance.
---
...
Self-hosting your Tofes-Mekovan instance requires your own certificate to sign documents. [This article](https://documenso.com/blog/building-documenso-pt1) explains why.
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the Tofes-Mekovan config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure Tofes-Mekovan to use the certificate
