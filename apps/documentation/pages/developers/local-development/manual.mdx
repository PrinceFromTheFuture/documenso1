---
title: Manual Setup
description: Manually set up Tofes-Mekovan on your machine for local development.
---
...
Follow these steps to set up Tofes-Mekovan on your local machine:

<Steps>

### Fork Tofes-Mekovan

Fork the [Tofes-Mekovan repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
