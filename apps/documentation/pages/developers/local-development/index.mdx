...
description: Learn how to set up Tofes-Mekovan for local development.
---

# Local development

There are multiple ways of setting up Tofes-Mekovan for local development. At the moment of writing this documentation, there are 3 ways of running Tofes-Mekovan locally:
...
<div className="mt-16 flex items-center justify-center gap-4">
  <a href="https://documen.so/discord">
    <img
      ...
      alt="Join Tofes-Mekovan on Discord"
    />
  </a>
