...
const themeConfig: DocsThemeConfig = {
  logo: <span>Tofes-Mekovan</span>,
  head: function useHead() {
    const config = useConfig<{ title?: string; description?: string }>();

    const title = `${config.frontMatter.title} | Tofes-Mekovan Docs` || 'Tofes-Mekovan Docs';
    const description = config.frontMatter.description || 'The official Tofes-Mekovan documentation';
  ...
  useNextSeoProps() {
    return {
      titleTemplate: '%s | Tofes-Mekovan Docs',
    };
  },
};
